    ...
    <div className="space-y-6">
      <div className="bg-white shadow overflow-hidden sm:rounded-lg">
        <div className="px-4 py-5 sm:px-6">
          <h3 className="text-lg leading-6 font-medium text-gray-900">Patient Vitals Recording</h3>
          <p className="mt-1 max-w-2xl text-sm text-gray-500">Record patient vitals before sending to the doctor</p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setSelectedPatient({...selectedPatient, weight: parseInt(e.target.value)})}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setSelectedPatient({...selectedPatient, height: parseInt(e.target.value)})}
                />
              </div>
